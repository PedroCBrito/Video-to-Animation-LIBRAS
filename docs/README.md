...
Personagem, rig e animação de referência permanecem indefinidos por solicitação do usuário. CP0–CP2 podem avançar até o esqueleto de origem; CP3 depende desse material. CP1.0–CP1.6 estão implementados e testados; a execução do FreeMoCap e os demais checkpoints permanecem pendentes.
